...
function start(){
  ...
  $('#optionsRadios2').on('change', function(){ // human vs bot - easy
    player2 = new EasyBot("Mr.Robot", "bot", "red");
    $('#player1').show(200);    
  	$('#player2').hide(200);
  });

 $('#optionsRadios3').on('change', function(){ //human vs bot - hard
    player2 = new SmartBot("Mr.Data", "bot", "red"); // for when we have a better bot
    $('#player1').show(200);  
    $('#player2').hide(200);
  });

  $('#optionsRadios4').on('change', function(){ // bot vs bot -easy
    player1 = new SmartBot("Mr.Robot", "bot", "black");// for when we can let the bots play against each other
    player2 = new SmartBot("Mr.Data", "bot", "red");
    $('#player1').hide(200);
    $('#player2').hide(200);
